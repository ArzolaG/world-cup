...
const Players = () => {
    return (
        <div className="flex flex-col items-center py-16 sm:py-32 px-5 gap-12 sm:gap-32 overflow-hidden" id="players">
            <h2 className="text-qatar text-5xl">Key Players</h2>
            <div className="grid  xl:grid-cols-2 gap-16 sm:gap-32 max-w-screen-xl">
